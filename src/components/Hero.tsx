      ...
      <div className="text-center max-w-4xl">
        ...
        >
          <h1 className="text-5xl md:text-5xl font-bold mb-4">
            {"PHAM HUY HOANG".split("").map((letter, index) => (
              <motion.span
                key={index}
        ...
        <motion.div
          ...
          className="space-y-4"
        >
          <div className="text-lg text-gray-400">Mid-level AI Engineer</div>
          <div className="text-blue-400">Building LLM systems with Python, Deep Learning, and Cloud platform</div>
        </motion.div>
      </div>
    </section>
  );
