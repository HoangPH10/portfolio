      ...
      <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {[
                  { icon: Mail, label: "hoangphamict@gmail.com", href: "mailto:hoangphamict@gmail.com", color: "from-red-400 to-pink-400" },
                  { icon: Phone, label: "+84395094728", href: "tel:+84395094728", color: "from-green-400 to-blue-400" },
                  { icon: Github, label: "GitHub Profile", href: "https://github.com/HoangPH10", color: "from-gray-400 to-gray-600" },
                  { icon: Linkedin, label: "LinkedIn Profile", href: "https://www.linkedin.com/in/hoang-pham-0005821bb/", color: "from-blue-400 to-blue-600" }
                ].map((social, index) => (
                  <motion.a
                    key={social.label}
                    href={social.href}
        ...
        >
          <p className="text-gray-500">
            © 2026 Hoang Pham. Engineering the future with AI.
          </p>
        </motion.div>
      </div>
    </section>
